...
public class Panel {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if(Tension.instance.setmgr.getSettingByName("Design").getValString().equalsIgnoreCase("New")){
		...
		}else if(Tension.instance.setmgr.getSettingByName("Design").getValString().equalsIgnoreCase("JellyLike")){
		...
		if (this.extended && !Elements.isEmpty()) {
			...
			int epanelcolor = Tension.instance.setmgr.getSettingByName("Design").getValString().equalsIgnoreCase("New") ? 0xff232323 : Tension.instance.setmgr.getSettingByName("Design").getValString().equalsIgnoreCase("JellyLike") ? 0xbb151515 : 0;;
