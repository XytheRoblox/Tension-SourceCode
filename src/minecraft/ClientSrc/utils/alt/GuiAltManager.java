...
extends GuiScreen {
        ...
        switch (button.id) {
            case 0: {
                if (this.loginThread == null) {
                    ...
                    Display.setTitle(Tension.fullname);
                    break;
                }
            ...
            case 2: {
                ...
                AltManager altManager = Tension.instance.altManager;
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        GL11.glEnable(3089);
        int y2 = 38;
        AltManager altManager2 = Tension.instance.altManager;
