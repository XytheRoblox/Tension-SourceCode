...
import ClientSrc.utils.alt.GuiAltManager;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
    	...
    	Tension.getDiscordRP().update("Idle", "Main Menu");
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if (button.id == 14 && this.realmsButton.visible)
        {
            ...
            Display.setTitle("Warning: The Alt Manager only works with accounts that are not migrated.");
        }
